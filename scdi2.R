...
cols<-c(rep("red",30),rep("black",N),rep("blue",70),rep("green",N),rep("purple",N),rep("cyan",N))
...
xxx<-fit.gplvm(data,2,plot.freq=500,Z.normal.prior=TRUE,groups=groups,sigma1_init=1)
...
colnames(xxxnew)<-(1:(dim(xxxnew)[2]))+150
