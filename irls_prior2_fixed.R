...
data4<-rmvnorm(50,rep(-3,300),diag(300))
data5<-rmvnorm(50,rep(3,300),diag(300))
data6<-rmvnorm(50,rep(6,300),diag(300))
...
source("kernels11_fixed.R")
source("GPLVM10_fixed.R")
xxx<-fit.gplvm(X=data,q=2,iterations=100,Z.normal.prior=TRUE,groups=groups,sigma1_init=1)
