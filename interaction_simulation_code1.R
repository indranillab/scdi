...
set.seed(0)
x1<-splatSimulate(params=newSplatParams(),method="groups",batchCells=c(100,100),group.prob=c(0.5,0.5),nGenes=10000,batch.facLoc=0.3,batch.facScale=0.3)
...
set.seed(0)
x1<-splatSimulate(params=newSplatParams(),method="groups",batchCells=c(100,100),group.prob=c(0.33,0.33,0.34),nGenes=10000,batch.facLoc=0.3,batch.facScale=0.3)
