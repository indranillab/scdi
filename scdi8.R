...
scdi<-function(data1,data2,K1,K2,data7,data8)
{
	x1<-fftRtsne(data7)
	x2<-fftRtsne(data8)
...
xxxnew1<-scdi(data1,data2,K1,K2,data7,data8)
...
rownames(A)<-1:(dim(data)[1])
colnames(A)<-1:(dim(data)[2])
...
xxx1<-fit.gplvm1(X[1:400,],max(K1,K2),iterations=100,Z.normal.prior=TRUE,groups=groups,sigma1_init=0)
